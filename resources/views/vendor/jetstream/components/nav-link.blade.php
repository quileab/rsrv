...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-0 border-b-2 border-indigo-400 bg-indigo-100 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition'
